...
def parse_detail(raw_list):
    ...
    for item in raw_list:
        ...
        parsed.append({
            ...
            "name": vals.get(0, ""),
            'price_change_ratio_pct': vals.get(1,''),
            "etf_up_trend_total_ratio": vals.get(2,''),
            "etf_up_trend_duration": vals.get(3,''),
            "etf_up_trend_consecutive_up_days": vals.get(4,''),
            "etf_limit_up_stock_cnt": vals.get(5,''),
            "etf_limit_up_stock_pct": vals.get(6,''),
            "full_code": item['code'],
        })
    return parsed
